...
namespace VisualiserWebProject.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "QuestionID,qText,qCorrectAnswer,qDistractor1,qDistractor2,qDistractor3")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "QuestionID,qText,qCorrectAnswer,qDistractor1,qDistractor2,qDistractor3")] Question question)
        {
            if (ModelState.IsValid)
            {
